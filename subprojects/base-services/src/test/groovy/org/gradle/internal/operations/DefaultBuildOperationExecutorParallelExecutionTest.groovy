...
class DefaultBuildOperationExecutorParallelExecutionTest extends ConcurrentSpec {
    ...
    def setupBuildOperationExecutor(int maxThreads) {
        ...
        buildOperationExecutor = new DefaultBuildOperationExecutor(
            operationListener, Mock(EventClock), new NoOpProgressLoggerFactory(),
    ...
    def "operations are canceled when the generator fails"() {
        ...
        def buildOperationExecutor = new DefaultBuildOperationExecutor(operationListener, Mock(EventClock), new NoOpProgressLoggerFactory(),
    ...
    def "registers/deregisters a listener for parallelism changes"() {
        ...
        when:
        buildOperationExecutor = new DefaultBuildOperationExecutor(operationListener, Mock(EventClock), new NoOpProgressLoggerFactory(),
