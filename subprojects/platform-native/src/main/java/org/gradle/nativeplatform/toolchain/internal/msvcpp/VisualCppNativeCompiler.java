...
class VisualCppNativeCompiler<T extends NativeCompileSpec> extends NativeCompiler<T> {
    ...
    VisualCppNativeCompiler(CompilerOutputFileNamingSchemeFactory compilerOutputFileNamingSchemeFactory, CommandLineToolContext invocationContext, ArgsTransformer<T> argsTransformer, Transformer<T, T> specTransformer, String objectFileExtension, boolean useCommandFile) {
